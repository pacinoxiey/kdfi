...
//        fileWriter.write(null); 不能直接写入 null
    ...
    public void test07() throws IOException {
        FileWriter fileWriter = new FileWriter(new File("").getAbsolutePath() + "/src/main/java/old.io/stream/test.txt", false); // 关闭追加模式，变为覆盖模式
    ...
    public void test08() throws IOException {
        FileReader fileReader = new FileReader(new File("").getAbsolutePath() + "/src/main/java/old.io/stream/test.txt");
